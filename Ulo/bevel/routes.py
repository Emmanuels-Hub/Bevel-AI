...
@bevel.route("/register/<email>/<password>/<name>")
...
@bevel.route("/login/<email>/<password>")
...
@bevel.route("/login_user/<email>/<password>")
...
@bevel.route("/create_user/<email>/<password>")
...
@bevel.route("/generate_chat/<content>")
